...
# the header file path must be exacly the same as the one passed to this
# function as part of ARGN!
#
# Example:
#
# \code
...
function (sbia_add_script_finalize TARGET_UID)
  ...
  set (OUTPUT_FILE  "${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${OUTPUT_NAME}")
  ...
  add_custom_target (${TARGET_UID}+ DEPENDS ${OUTPUT_FILES})
