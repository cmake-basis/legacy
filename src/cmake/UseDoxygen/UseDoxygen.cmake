...
#
#  DOXYFILE_IN - (Optional) Path to the doxyfile containing the configuration for your doxygn build. 
#                           If the file is not specified a default file is provided. 
...
if(EXISTS "${DOXYFILE_IN}")
  set(DOXYFILE_IN_FOUND TRUE)
endif()

if(DOXYGEN_FOUND AND NOT DOXYFILE_IN_FOUND)
	find_file(DOXYFILE_IN "Doxyfile.in"
			PATHS 
			  "${CMAKE_CURRENT_SOURCE_DIR}" 
			  "${CMAKE_MESH_USE_DOXYGEN_PATH}" 
			  "${CMAKE_MESH_PATH}/UseDoxygen"
			  "${CMAKE_MODULE_PATH}"
			NO_DEFAULT_PATH
