...
macro(vc_set_gnu_buildtype_flags)
   ...
   if(CMAKE_BUILD_TYPE STREQUAL "Release" OR CMAKE_BUILD_TYPE STREQUAL "RelWithDebInfo" OR CMAKE_BUILD_TYPE STREQUAL "RelWithDebug")
      set(ENABLE_STRICT_ALIASING FALSE CACHE BOOL "Enables strict aliasing rules for more aggressive optimizations, may result in extremely difficult to diagnose bugs")
...
macro(vc_set_preferred_compiler_flags)
   ...
   elseif(Vc_COMPILER_IS_GCC)
      ...
      ##################################################################################################
      if(_add_warning_flags)
         set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -W -Wall -Wswitch -Wformat -Wchar-subscripts -Wparentheses -Wmultichar -Wtrigraphs -Wpointer-arith -Wcast-align -Wreturn-type -Wno-unused-function -pedantic -Wno-long-long")# Removed:  -Wshadow
         set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -W -Wall -Wswitch -Wformat -Wchar-subscripts -Wparentheses -Wmultichar -Wtrigraphs -Wpointer-arith -Wcast-align -Wreturn-type -Wno-unused-function -pedantic -Wno-long-long")# Removed:  -Wshadow
         if(NOT WIN32)
