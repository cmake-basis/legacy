...
set (CXX_LIBRARY_TARGET      cxxutils)
set (TEST_LIBRARY_TARGET     cxxtestlib)
set (TESTMAIN_LIBRARY_TARGET cxxtestmain)
...
# functions can add a dependency on this target when building BASIS
if (BASIS_USE_FULLY_QUALIFIED_UIDS)
  set (BASIS_CxxUtilities_LIBRARY "basis.${CXX_LIBRARY_TARGET}")
else ()
  set (BASIS_CxxUtilities_LIBRARY "${CXX_LIBRARY_TARGET}")
endif ()
